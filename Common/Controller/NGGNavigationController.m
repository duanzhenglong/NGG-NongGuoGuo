...
@interface NGGNavigationController ()<UIGestureRecognizerDelegate>
...
- (void)viewDidLoad {
    ...
    /***设置导航栏的字体大小和粗细***/
    [self.navigationBar setTitleTextAttributes:@{NSFontAttributeName:[UIFont systemFontOfSize:18 weight:1],NSForegroundColorAttributeName:[UIColor whiteColor]}];
}
...
- (void)pushViewController:(UIViewController *)viewController animated:(BOOL)animated
{
    if (self.childViewControllers.count > 0) { // 如果viewController不是最早push进来的子控制器
        ...
        [backButton.titleLabel setFont:[UIFont systemFontOfSize:17 weight:1]];
