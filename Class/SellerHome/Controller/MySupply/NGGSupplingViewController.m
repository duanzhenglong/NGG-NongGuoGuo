...
@interface NGGSupplingViewController ()
 /***数据数组***/
@property (strong, nonatomic) NSArray* DataArray;
@end

@implementation NGGSupplingViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    self.view.backgroundColor=NGGCommonBgColor;
    self.tableView.contentInset=UIEdgeInsetsMake(30, 0, 59, 0);
