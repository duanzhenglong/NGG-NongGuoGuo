...
#import "NGGSupplingViewController.h"
@interface NGGMySupplyViewController ()<UIScrollViewDelegate>
...
@implementation NGGMySupplyViewController
...
-(void)addTableViews{
    /*供应中*/
    NGGSupplingViewController*RecomView=[[NGGSupplingViewController alloc]init];
    [self addChildViewController:RecomView];
    /*供应结束*/
    NGGEndSupplyViewController*HotNewsView=[[NGGEndSupplyViewController alloc]init];
