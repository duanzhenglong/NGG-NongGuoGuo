...
@interface NGGFisheriesViewController ()
@property(strong, nonatomic) NSArray *DataArray;
@end

@implementation NGGFisheriesViewController
...
- (void)viewDidLoad {
  ...
  [self createInitdate];
  /*获取网络数据进行解析*/
  [self requestFisheries];
}

- (void)createInitdate {
  self.navigationItem.title = @"水产";
