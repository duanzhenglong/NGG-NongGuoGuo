...
@interface NGGLivestockViewController ()
@property(strong, nonatomic) NSArray *DataArray;
@end

@implementation NGGLivestockViewController
...
- (void)viewDidLoad {
  ...
  [self createInitdate];
  /*获取网络数据进行解析*/
  [self requestLivestock];
}

- (void)createInitdate {
  self.navigationItem.title = @"禽畜";
