...
@implementation NGGDonePurchaseCell
...
- (void)CreatCustomizeControls {
  ...
  /*创建第二个cell的view*/
  UIView *views =
      [[UIView alloc] initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, 256)];
  ...
  /*创建descLab*/
  self.DescLab = [[UILabel alloc]
      initWithFrame:CGRectMake(10, self.ProductLab.frame.origin.y + 210, 200,
                               40)];
  [self.DescLab setTextColor:NGGTheMeColor];
  self.DescLab.text = @"备注:";
  ...
  /*创建descLab*/
  self.DescLab = [[UILabel alloc]
      initWithFrame:CGRectMake(100, self.VarietyLab.frame.origin.y + 210, 200,
                               40)];
